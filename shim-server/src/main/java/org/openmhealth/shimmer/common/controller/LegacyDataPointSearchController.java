...
import org.slf4j.Logger;               //*LDG Added this to do logging
import org.slf4j.LoggerFactory;        //*LDG Added this to do logging
...
public class LegacyDataPointSearchController {
    ...
    private static final Logger logger = LoggerFactory.getLogger(LegacyDataPointSearchController.class);        //*LDG Added this to do logging
    ...
    public ShimDataResponse data(
        ...
        logger.info("OK, just got a data request for "+username);           //*LDG Just testing
        ...
        //Look in the Mongo database to get the serialized access token
        ...
        //Do the data request using the correct shim
