...
public class LegacyAuthorizationController {
    ...
    public AuthorizationRequestParameters initiateAuthorization(
        ...
        logger.info("Received /authorize/{} request with username {}", shim, username);
    ...
    public ResponseEntity<AuthorizationResponse> processRedirect(
        ...
        logger.info("A redirect has been received for shim '{}' with state key '{}'.", shimKey, stateKey);
        logger.info("servletRequest RequestURL is: " + servletRequest.getRequestURL());
        logger.info("servletRequest QueryString is: " + servletRequest.getQueryString());
        ...
        logger.info("AuthorizationResponse.Type is: " + response.getType());
        ...
        logger.info("AuthorizationResponse.RequestParameters are: " + authParams.getRequestParams());
        logger.info("AuthorizationResponse.getClientRedirectUrl are: " + authParams.getClientRedirectUrl());
