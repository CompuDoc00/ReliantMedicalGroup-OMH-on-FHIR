...
public class GoogleFitShim extends OAuth2Shim {
    ...
    public ShimDataType[] getShimDataTypes() {
        ...
        return new GoogleFitDataTypes[] {
                GoogleFitDataTypes.BODY_HEIGHT, // order important because first is picked for trigger call
    ...
    private class GoogleTokenRequestEnhancer implements RequestEnhancer {
        ...
        public void enhance(AccessTokenRequest request,
            ...
            headers.remove(HttpHeaders.AUTHORIZATION);                          //*LDG added this because GoogleAPI doesn't uas Basic Auth formatting because we use TLS
